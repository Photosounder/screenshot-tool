...
void screenshot_editor(int *shot_flag, int *hide_flag, int *exit_flag)
{
	...
	const char *layout_src[] = {
		...
		"elem 70", "type knob", "label Top", "knob 0 0 1080 linear %.0f", "pos	1;6	-1", "dim	0;8", "off	0;6	1", "",
		"elem 71", "type knob", "label Left", "knob 0 0 1920 linear %.0f", "pos	0;8	-1;5", "dim	0;8", "off	0;6	1", "",
		"elem 72", "type knob", "label Right", "knob 0 0 1920 linear %.0f", "pos	2;4	-1;5", "dim	0;8", "off	0;6	1", "",
		"elem 73", "type knob", "label Bottom", "knob 0 0 1080 linear %.0f", "pos	1;6	-1;10", "dim	0;8", "off	0;6	1", "",
